        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-5 items-stretch">
          {KEY_ACHIEVEMENTS.map((a, i) => (
            <Reveal key={i} delay={i * 0.07} className="h-full">
              <div className="gc py-9 px-6 text-center relative overflow-hidden h-full flex flex-col justify-center">
                <div className="glow-line-top" />
                <div className="font-serif text-4xl lg:text-5xl font-normal text-brand tracking-tight leading-none">{a.value}</div>
